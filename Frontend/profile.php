...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <main class="container py-5 flex-grow-1">
        ...
        <?php if (isset($_SESSION["Login"]) && $_SESSION["Login"] === "YES"): ?>
            <div class="welcome-banner text-center mb-5 bg-white shadow-sm p-4 rounded-4 border">
                <h1 class="h3 fw-bold text-dark">Welcome <?php echo htmlspecialchars($_SESSION['name']); ?></h1>
                
                <?php $img_src = !empty($_SESSION['picture']) ? $_SESSION['picture'] : 'default.png'; ?>
                <img src="../uploads/<?php echo htmlspecialchars($img_src); ?>" width="100" height="100" alt="Profile Picture" class="rounded-circle shadow-sm my-2 border">
                
                <p class="text-secondary small mb-0 fw-bold">Session established at: <span class="text-primary"><?php echo $_SESSION["datetime"]; ?></span></p>
            </div>
        <?php endif; ?>
            ...
            <aside class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    <div class="text-center mb-4 border-bottom pb-4">
                        ...
                        <h2 class="h5 fw-bold text-dark mb-1"><?php echo htmlspecialchars($user['name']); ?></h2>
